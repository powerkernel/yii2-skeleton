...
class SettingController extends BackendController
{
    ...
    public static function updateSetting()
    {
        ...
        $s = [
            ...
            //['key' => 'passwordLessLogin', 'value' => '0', 'title' => 'Password Less Login', 'description' => 'Login without password', 'group' => 'Account', 'type' => 'dropDownList', 'data' => json_encode(Core::getYesNoOption()), 'default' => '1', 'rules' => json_encode(['required' => [], 'boolean' => []])],
