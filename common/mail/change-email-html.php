...
?>
<span class="preheader" style="margin: 0; box-sizing: border-box; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 1px; display: none; mso-hide: all; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; line-height: 1px;"><?= Yii::t('app', '{CODE} is your verification code.', ['CODE' => $model->new_email_code]) ?></span>
