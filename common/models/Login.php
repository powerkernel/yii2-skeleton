...
class Login extends ActiveRecord
{
    ...
    public function beforeSave($insert)
    {
        if($insert){
            ...
            if($this->admin){
                ...
                if($account){
                    if(!Yii::$app->authManager->checkAccess($account->id, 'admin')){
                        return false;
                    }
                }
            }
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if($insert){
            ...
            $login['name']=$name;
            $login['link']=Yii::$app->urlManagerFrontend->createAbsoluteUrl(['/site/login', 'email'=>$this->email, 'token'=>$this->token, 'remember'=>$this->remember]);
            if($this->admin){
